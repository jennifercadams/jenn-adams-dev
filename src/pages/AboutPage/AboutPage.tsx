    ...
    return (
        <div id="about">
            <div id="me">
                ...
                <p>In my personal life, I enjoy reading, writing, video games, TTRPGs, baking, and spending time with my dog Wednesday.</p>
            </div>
            <div id="wednesday">
                <img src="./src/assets/images/Wednesday.jpg" />
            </div>
        </div>
    );
};
